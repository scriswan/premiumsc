...
echo -e "\033[96;1m│\e[97m  Owner   : JESVPN STORE\033[0m "
echo -e "\033[96;1m│\e[97m  Expired : $exp ${WHITE}\033[0m"
echo -e "\033[96;1m|\e[97m  Tersisa : ${WHITE}$exp2${WHITE}hari lagi. \033[0m "
echo -e "\033[96;1m╰══════════════════════════════════════════════════════════╯\033[0m "
echo -e "\033[96;1m╭══════════════════════════════════════════════════════════╮\033[0m "
echo -e "\033[1m${LIGHTBLUE}┃${NC} ${BIRed} ${WHITE}                 ${LIGHTBLUE}PILIHAN MENU OPTIONS${NC}                     ${LIGHTBLUE}┃\033[0m${NC}"
