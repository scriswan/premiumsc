...
Exp=$(curl -sS https://raw.githubusercontent.com/Lite-VPN/premiumsc/main/register | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/Lite-VPN/premiumsc/main/version)
